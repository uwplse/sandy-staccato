...
JMETER_DIR="/home/staccato/apache-jmeter-2.12/"
...
def run_jmeter(run_spec, test_file, dir_name, random_seed, iterations = 550):
    (proc, cont) = get_jmeter_proc(run_spec, test_file, dir_name, random_seed, iterations)
    proc.wait()
    return cont()

def get_jmeter_proc(run_spec, test_file, dir_name, random_seed, iterations = 550):
    ...
    def continuation():
        ...
        if run_spec.measure_mem:
            ...
            return data_file
    return (jmeter_proc, continuation)
